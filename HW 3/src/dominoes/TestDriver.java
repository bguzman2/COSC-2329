...
public class TestDriver {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            //Domino dominoHighLowString2 = new DominoHighLowImpl_Beneski("4*2");
            ...
            highLowSet1.add(6);
            Set<Integer> highLowSet2 = new HashSet<>();
            highLowSet2.add(6);
            highLowSet2.add(6);
            Set<Integer> highLowSet3 = new HashSet<>();
            highLowSet3.add(5);
            highLowSet3.add(1);
            Set<Integer> highLowSet4 = new HashSet<>();
            ...
            Domino dominoHighLowSet4 = new DominoHighLowImpl_Beneski(highLowSet4);
            System.out.println(dominoHighLowSet4.getHighPipCount() + " " + dominoHighLowSet4.getLowPipCount());
...
//        System.out.println(dominoHighPipLowPip4.getHighPipCount() + " " + dominoHighPipLowPip4.getLowPipCount());
            ...
            System.err.println("You Violated a Preconditon" + error);
