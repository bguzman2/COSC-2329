...
import change.ChangeMakerImpl_Beneski;
...
public class ChangeMakerTestCases
{
	...
	{
		return new ChangeMakerImpl_Beneski(denominations);
	}

	@Points(value=5)
	@Test
	public void canMakeExactChangeUSCoins__65()
	{
	...
	@Points(value=5)
	@Test
	public void getExactChangeUSCoins__65()
	{
		Set<Integer> usCoinDenominationSet = getUSCoinDenominationSet();
		int valueInCents = 65;
	...
	@Points(value=5)
	@Test
	public void canMakeExactChangeUSCoins__55()
	{
		Set<Integer> usCoinDenominationSet = getUSCoinDenominationSet();
		int valueInCents = 55;
	...
	@Points(value=5)
	@Test
	public void canMakeExactChangeUSCoins__10()
	{
		Set<Integer> usCoinDenominationSet = getUSCoinDenominationSet();
		int valueInCents = 10;
	...
	@Points(value=5)
	@Test
	public void canMakeExactChangeUSCoins__11()
	{
		Set<Integer> usCoinDenominationSet = getUSCoinDenominationSet();
		int valueInCents = 11;
	...
	@Points(value=5)
	@Test
	public void canMakeExactChangeUSCoins__180004()
	{
		Set<Integer> usCoinDenominationSet = getUSCoinDenominationSet();
	...
	@Points(value=5)
	@Test
	public void canMakeExactChange_32_16_8_4_2_1__0()
	{
	...
	@Points(value=5)
	@Test
	public void getExactChange_32_16_8_4_2_1__0()
	{
		Set<Integer> denominationSet = getDenominationSet(new Integer[]{32, 16, 8, 4, 2, 1});
		int valueInCents = 0;
	...
	@Points(value=5)
	@Test
	public void canMakeExactChange_144_89_55_34_21_13_8_5_3_2_1__0()
	{
	...
	@Points(value=5)
	@Test
	public void canMakeExactChange_144_89_55_34_21_13_8_5_3_2_1__201()
	{
		Set<Integer> denominationSet = getDenominationSet(new Integer[]{144,89,55,34,21,13,8,5,3,2,1});
	...
	@Points(value=5)
	@Test
	public void canMakeExactChange_16777216_ETC__88888888()
	{
	...
	@Points(value=5)
	@Test
	public void calculateValueOfChangeList_537824_38416_2744_196_14_1__0_0_0_0_0_0()
	{
		Set<Integer> denominationSet = getDenominationSet(new Integer[]{537824,38416,2744,196,14,1});
		List<Integer> coinCountList = Arrays.asList(0,0,0,0,0,0);

		TEST_GOAL_MESSAGE = "Test " + getPrettyString(denominationSet) + ".calculateValueOfChangeList(" + coinCountList + ")";
		changeMaker_STUDENT = getChangeMaker(denominationSet);

		//TODO
		assertTrue(changeMaker_STUDENT.calculateValueOfChangeList(coinCountList) == 0);
	}
	...
	@Points(value=5)
	@Test
	public void canMakeExactChange_8000_400_20_1__492()
	{
