...
import bingo.BingoCardDiagonalListBasedImpl_Beneski;
...
public class BingoCardDiagonalListBasedImplTests_SUBSETFORSTUDENTS
{
	@Test
...
//			assert row_i_entries.length == BingoCard.COLUMN_COUNT : "row_i_entries.length = " + row_i_entries.length + " <> " + BingoCard.COLUMN_COUNT + " = BingoCard.COLUMN_COUNT!";
		...
		return new BingoCardDiagonalListBasedImpl_Beneski(entries);
