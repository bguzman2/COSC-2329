...
import bingo.BingoCardRowListBasedImpl_Beneski;
...
public class BingoCardRowListBasedImplTests_SUBSETFORSTUDENTS
{
	@Test
	...
	private static BingoCard getBingoCard(Integer[][] entries)
	{
		...
		return new BingoCardRowListBasedImpl_Beneski(entries);
